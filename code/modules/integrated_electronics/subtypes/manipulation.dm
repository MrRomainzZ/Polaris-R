...
/obj/item/integrated_circuit/manipulation/grenade/proc/attach_grenade(var/obj/item/grenade/G)
	attached_grenade = G
	GLOB.destroyed_event.register(attached_grenade, src, TYPE_PROC_REF(/obj/item/integrated_circuit/manipulation/grenade, detach_grenade))
	size += G.w_class
...
/obj/item/integrated_circuit/manipulation/grenade/proc/detach_grenade()
	if(!attached_grenade)
		return
	GLOB.destroyed_event.unregister(attached_grenade, src, TYPE_PROC_REF(/obj/item/integrated_circuit/manipulation/grenade, detach_grenade))
