...
/obj/machinery/librarypubliccomp/attack_hand(var/mob/user as mob)
	usr.set_machine(src)
	var/dat = "<HEAD><TITLE>Library Visitor</TITLE></HEAD><meta charset=UTF-8><BODY>\n" // <META HTTP-EQUIV='Refresh' CONTENT='10'>
	switch(screenstate)
		if(0)
...
/obj/machinery/librarycomp/attack_hand(var/mob/user as mob)
	usr.set_machine(src)
	var/dat = "<HEAD><TITLE>Book Inventory Management</TITLE></HEAD><meta charset=UTF-8><BODY>\n" // <META HTTP-EQUIV='Refresh' CONTENT='10'>
	switch(screenstate)
		if(0)
			// Main Menu
...
/obj/machinery/libraryscanner/attack_hand(var/mob/user as mob)
	usr.set_machine(src)
	var/dat = "<meta charset=\"UTF-8\"><HEAD><TITLE>Scanner Control Interface</TITLE></HEAD><meta charset=UTF-8><BODY>\n" // <META HTTP-EQUIV='Refresh' CONTENT='10'>
	if(cache)
